...
def test_find_by_email_found(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_find_by_email_not_found(user_repository: UserRepository, mock_supabase: MagicMock) -> None:
...
def test_find_by_cnpj_found(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_create_user(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_create_mei(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_update_password(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_update_profile(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_update_cnpj(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:
...
def test_anonymize_user(user_repository: UserRepository, mock_supabase: MagicMock) -> None:
...
def test_link_interested_states(user_repository: UserRepository, mock_supabase: MagicMock) -> None:
...
def test_get_interested_states(user_repository: UserRepository, mock_supabase: MagicMock) -> None:
...
def test_mark_registration_complete(user_repository: UserRepository, mock_supabase: MagicMock, mock_user_data: dict[str, Any]) -> None:

...
class CategoryClassifier:
    ...
    CNAES_MEI = [
        ...
        {"codigo": "4322-3/02", "descricao": "Instalação e manutenção de sistemas centrais de ar condicionado"},
    ...
    def classify(self, objeto_compra: str) -> dict[str, Any]:
        ...
        """
        prompt = f"""
Você é um especialista em classificação de licitações públicas para MEI (Microempreendedor Individual).

Analise o seguinte objeto de licitação e identifique até 3 categorias CNAE MEI mais adequadas:
